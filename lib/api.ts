import { ConflictData } from '@/types/Api'
...
export function createdResponse(data: string) {
...
export function conflictResponse(errorMessage?: string, conflictData?: ConflictData) {
...
export function internalServerErrorResponse(errorMessage?: string | {}) {
...
export function serviceUnavailableResponse(errorMessage?: string | {}) {
  return jsonResponse(503, { error: errorMessage ?? 'Service unavailable' })
}
